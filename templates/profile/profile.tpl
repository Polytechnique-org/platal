...
<div id="fiche">
  ...
  <div id="fiche_identite" class="part">
    <div class="civilite">
      ...
      &nbsp;(<span title="Identifiant AX, uniquement visible par les administrateurs du site" style="font-weight:normal;font-style:italic;">AX <a href="http://kx.polytechniciens.com/?page=AX_FICHE_ANCIEN&ancc_id={$profile->ax_id}">{$profile->ax_id}</a></span>
        |
        <span title="Maticule École, uniquement visible par les administrateurs du site" style="font-weight:normal;font-style:italic;">X {$profile->schoolId()}</span>)
      {/if}
