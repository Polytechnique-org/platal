...
{if $isX}* tu {if $promoGroup}es{else}n’es pas{/if} inscrit à ton groupe promo sur Polytechnique.net. {if !$promoGroup}N'hésite pas à t'inscrire [[http://www.polytechnique.net/{$promoX}|ici]].{/if}{/if}
