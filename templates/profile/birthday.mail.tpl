...
{if $isX}* tu {if $mlpromo}es{else}n’es pas{/if} inscrit à ta liste promo@{$promoX}.polytechnique.org qui te permet de garder le contact avec tes cocons. {if !$mlpromo}N'hésite pas à t'inscrire [[https://listes.polytechnique.org/members/promo_{$promoX}.polytechnique.org|ici]].{/if}{/if}

Enfin, n’oublie pas que la qualité de l’annuaire dépend également de la mise à jour régulière de ta fiche{if $recent_update} comme tu le fais{else}, n’hésite pas à [[https://www.polytechnique.org/profile/{$hrid}|aller la voir]] pour vérifier qu’elle est bien à jour{/if}. {if isX}Tu peux également vérifier que tes cocons sont joignables sur leur adresse sur [[https://www.polytechnique.org/search/adv?rechercher=Chercher&amp;egal1=%3D&amp;promo1={$promoX}&amp;edu_type=Ing&eacute;nieur&amp;has_email_redirect=2&amp;alive=1|cette page]].
