...
<div id="content">
  ...
  <ul class="descr">
    <li>
    <a href="creategpx">sur la création d'un groupe X</a>;
    </li>
    <li>
    <a href="article12">l'article 12 des statuts de l'AX</a>;
    </li>
    <li>
    <a href="article16">l'article 16 du réglement intérieur de l'AX</a>.
    </li>
  </ul>
