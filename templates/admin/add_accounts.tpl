...
{if $add_type eq 'promo'}
  <tr>
    <td class="center">
      ...
      <label class="nowrap"><input type="radio" name="edu_type" value="M" /> master et MSc&amp;T&ge;2019</label> -
      ...
      <label class="nowrap"><input type="radio" name="edu_type" value="G" /> graduate&le;2018</label> -
