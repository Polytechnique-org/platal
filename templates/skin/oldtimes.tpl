...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  {else}
    ...
    <table id="body" cellpadding="0" cellspacing="0">
      <tr>
        <td id="body-logo">
          <a href="events"><img src="images/skins/oldtimes_logo.gif" alt="[ LOGO ]" /></a>
        </td>
        <td id="body-top">
          <a href="events"><img src="images/skins/oldtimes_ban.jpg" alt="[ Polytechnique.org ]" /></a>
          {include file="skin/common.title.header.tpl"}
          <a href="events"><img src="images/skins/oldtimes_lesX.gif" alt="[LES X SUR LE WEB]" /></a>
        </td>
      </tr>
      <tr>
        <td id="body-menu">
