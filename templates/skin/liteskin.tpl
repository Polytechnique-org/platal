...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  {else}
    ...
    <table id="body" cellpadding="0" cellspacing="0">
      <tr>
        <td id="body-logo">
          <a href="{rel}/events"><img src="{rel}/images/sk_liteskin_logo.png" alt="[ LOGO ]" /></a>
        </td>
        <td id="body-top">
          <a href="{rel}/events"><img src="{rel}/images/sk_liteskin_titre.png" alt="[ Polytechnique.org ]" /></a>
